...
public class CustomerMapActivity extends AppCompatActivity implements OnMapReadyCallback {
   ...
   // private String customerID;
    ...
    private Button customerCallaCab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driverLogoutBtn = findViewById(R.id.customerLogoutBtn);
        driverSettingsBtn = findViewById(R.id.customerSettingsBtn);
        customerCallaCab = findViewById(R.id.callAcabBtn);
        DatabaseReference customerDatabaseRef = FirebaseDatabase.getInstance().getReference().child("CustomerRequests");
        ...
        customerCallaCab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                @SuppressLint("MissingPermission") Location location = locationManager.getLastKnownLocation(provider);
                   ...
                   customerCallaCab.setText("Getting your Driver...");
                    //getClosestDriver();
           }
